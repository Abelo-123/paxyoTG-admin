...
const Tab = () => {
    ...
    return (
        ...
        <>
            ...
            <Tabbar style={{ color: 'black', background: 'var(--tgui--secondary_bg_color)', border: '2px solid var(--tgui--section_bg_color)', display: 'grid', margin: '0rem', placeItems: 'center', gridTemplateColumns: 'repeat(4, 1fr)' }}>
                ...
                <Tabbar.Item onClick={() => updateActivePage(4)}>
                    <div className='flex flex-col'>
                        ...
                        <Text weight="3" style={{ color: activePage === 4 ? 'var(--tgui--link_color)' : 'var(--tgui--subtitle_text_color)', fontSize: '0.82rem' }}>Dashboard</Text>
                    </div>
                </Tabbar.Item>
