  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on("postgres_changes", { event: "INSERT", schema: "public", table: "adminmessage" }, (payload) => {
        ...
        if (Number(payload.new.father) === userData.userId && Number(payload.new.for) === userData.userId && payload.new.seen === true) {
          // console.log("New admin message for to=100:", payload.new);
        ...
        <div className='w-screen' >
          {
            useNotification.notificationModal && (
              <div style={{
                zIndex: 900, background: 'var(--tgui--section_bg_color)', color: 'var(--tgui--section_header_text_color)',
